  ...
  return (
    <div className="relative">
      <input
        ...
        {...props}
        placeholder={placeholder}
        className={`dark:bg-[#141625] py-2 px-4 border-gray-300 border-[.2px] dark:border-gray-800   rounded-lg  items-center bg-[#E2DDF4] ${error ? 'outline-red-400 focus:outline-red-400' : ' focus:outline-purple-400'} outline-none focus:ring-0 w-${width || 'full'}`}
        style={{
          appearance: 'textfield',
          MozAppearance: 'textfield',
        }}
